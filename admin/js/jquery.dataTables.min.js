...
fnStateSave:function(e,i){this.oApi._fnCreateCookie(e.sCookiePrefix+e.sInstance,this.oApi._fnJsonString(i),e.iCookieDuration,e.sCookiePrefix,e.fnCookieCallback)},fnStateSaveParams:null,iCookieDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iScrollLoadGap:100,iTabIndex:0,oLanguage:{oAria:{sSortAscending:": activate \n\
 sort column ascending",sSortDescending:": activate до sort column descending"},oPaginate:{sFirst:"First",sLast:"Last",sNext:"Вперед",sPrevious:"Назад"},sEmptyTable:"No data available in table",
sInfo:"Showing _START_ до _END_ из _TOTAL_  ",sInfoEmpty:"Showing 0 до 0 из 0  ",sInfoFiltered:"(filtered from _MAX_ total  )",sInfoPostFix:"",sInfoThousands:",",sLengthMenu:"Показать _MENU_  ",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Поиск:" ,sUrl:"",sZeroRecords:"No matching records found"},oSearch:i.extend({},j.models.oSearch),sAjaxDataProp:"aaData",sAjaxSource:null,sCookiePrefix:"SpryMedia_DataTables_",sDom:"lfrtip",sPaginationType:"two_button",sScrollX:"",
