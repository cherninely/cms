...
<form id="form" action="<?=current_url()?>/" method="post">
    ...
    <div id="fields_with_errors">
       <input name="menu_name" maxlength="40" type="text"  value="<?=$data[0]['menu_name']?>" onblur="if (this.value=='') this.value='Введите название меню';" onfocus="if (this.value=='Введите название меню') this.value='';"/>
